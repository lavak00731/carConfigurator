                ...
                <div className="col-12 col-sm-8">
                    ...
                    <Form>
                        <Form.Group className="mb-3" controlId="formBasicName">                            
                            <Form.Control type="text" placeholder="EG 'John Smith III'" aria-describedby="fullNameHelp" />
                        ...
                        <Form.Group className="mb-3" controlId="formBasicEmail">
                            ...
                            <Form.Control type="email" placeholder="Enter email" aria-describedby="emailHelp" />
                        ...
                        <Form.Group className="mb-3" controlId="formTelephone">
                            ...
                            <Form.Control type="phone" placeholder="140845645630" aria-describedby="phoneHelp"/>
                        ...
                        <Form.Group className="mb-3" controlId="formCreditCard">
                            ...
                            <Form.Control type="phone" placeholder="xxxx xxxx xxxx xxxx" />
                        </Form.Group>
