...
export const ShareBtns = ({location}) => {
  const encodedUrl = encodeURIComponent(location);
  return (
    <div className="col-12 order-lg-3">
      <a
        className="resp-sharing-button__link"
        href={"https://facebook.com/sharer/sharer.php?u="+ location}
        target="_blank"
        rel="noopener"
      >
      ...
      <a
        className="resp-sharing-button__link"
        href={"mailto:?subject=Great%20car%20configurator&amp;body="+location}
        target="_self"
        rel="noopener"
      >
      ...
      <a
        className="resp-sharing-button__link"
        href={"whatsapp://send?text=Great%20car%20configurator%20by%20Lavak00731%20"+encodedUrl}
        target="_blank"
        rel="noopener"
      >
